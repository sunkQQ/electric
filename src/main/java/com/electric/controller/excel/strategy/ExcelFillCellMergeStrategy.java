package com.electric.controller.excel.strategy;
...
public class ExcelFillCellMergeStrategy implements CellWriteHandler {
    ...
    private void mergeWithPrevRow(WriteSheetHolder writeSheetHolder, Cell cell, int curRowIndex, int curColIndex) {
        Object curData = cell.getCellType().equals(CellType.STRING) ? cell.getStringCellValue() : cell.getNumericCellValue();
        ...
        Object preData = preCell.getCellType().equals(CellType.STRING) ? preCell.getStringCellValue() : preCell.getNumericCellValue();
        //不需要合并的列直接跳出
        ...
        boolean equals = cell.getRow().getCell(0).getStringCellValue()
            .equals(cell.getSheet().getRow(curRowIndex - 1).getCell(0).getStringCellValue());
        if (dataBool && equals) {
