...
public class JiaofeiYouCaiController {
    ...
    public String query(JiaofeiYoucaiBaseParam param) {
        ...
        studentInfo.setStudentCode(studentParam.getStudentCode());
    ...
    public String getFeeItem(JiaofeiYoucaiBaseParam param) {
        ...
        result.setStudentCode(studentParam.getStudentCode());
        ...
        items1.setFee(new BigDecimal("18000.00"));
        ...
        items2.setFee(new BigDecimal("181000.00"));
