package com.electric.model.constant;
...
public class Numbers {
    ...
    public static final int    INT_604       = 604;
    ...
    /** 四周的毫秒数 */
    public static final int    FOUR_WEEK     = 4 * WEEK;
    /** 一天的秒数 */
    ...
    public static final long   LONG_152      = 152L;
    public static final long   LONG_240      = 240L;
